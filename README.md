...
这是“团队知识库”的公开安装外壳。仓库不包含团队资料、成员信息、密码、OAuth 凭据、服务器密钥或私有 Git 内容。
...
- 查看及恢复版本
- 移入回收站、恢复和撤销操作
- 兼容现有 Obsidian Markdown、Frontmatter、Wiki Link 和附件相对路径

永久删除、清空回收站、修改成员权限和改写 Git 历史不会开放给 Agent。
大文件上传适配尚未开放；超过 512 KiB 的文件请暂时继续使用小O协作或 Obsidian 既有上传方式。
